		...
		<div id="content">
				...
				<table class="shop_table beta-shopping-cart-table" cellspacing="0">
					...
					<?php
                        ...
                        foreach($_SESSION['cart'] as $key => $cart){ 
                            $total_price =  $total_price + $cart['pro_price']*$cart['pro_quantity'];
                            ?>
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" style="height: 80px;" src="<?php echo $cart['pro_image']; ?>" alt="">
									<div class="media-body">
										<p class="font-large table-title"><?php echo $cart['pro_name']; ?></p>
										<p class="table-option">Color: <?php echo $cart['pro_color']; ?></p>
										<p class="table-option">Size: <?php echo $cart['pro_size'] ?></p>
							...
							<td class="product-price">
								<span class="amount"><?php echo number_format($cart['pro_price'],0,'.','.'); ?></span>
							</td>
							...
							<td class="product-quantity">
								<select name="product-qty" class="update_pro_shoppping" id="<?php echo $key; ?>">
									<?php
                                        for($i=1;$i<=30;$i++){ ?>
                                        <option  <?php if($cart['pro_quantity']==$i){ ?> selected <?php }?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                       <?php  } ?>
								</select>
							</td>

							<td class="product-subtotal">
								<span class="amount"><?php echo number_format($cart['pro_price']*$cart['pro_quantity'],0,'.','.') ?></span>
							</td>

							<td class="product-remove">
								<a href="#" class="delete_pro"   id="<?php echo $key; ?>" class="remove" title="Remove this item"><i style="font-size: 24px;" class="fa fa-trash-o"></i></a>
							</td>
						</tr>
                    <?php } ?>	
					</tbody>
					...
					<tfoot>
						...
						<tr>
							<td colspan="6" class="actions">
								...
								<a href="index.php?page=checkout"><button type="submit" class="beta-btn primary" name="proceed">Thanh toán<i class="fa fa-chevron-right"></i></button></a>
							</td>
						</tr>
					</tfoot>
				</table>
			...
			<div class="cart-collaterals">
				...
				<div class="cart-totals pull-right" style="width: 500px;">
					...
					<div class="cart-totals-row"><span>Cart Subtotal:</span> <span><?php echo number_format($total_price,0,'.','.');  ?> vnđ</span></div>
					<div class="cart-totals-row"><span>Shipping:</span> <span>Free Shipping</span></div>
					<div class="cart-totals-row"><span>Order Total:</span> <span><?php echo number_format($total_price,0,'.','.');  ?> vnđ</span></div>
				</div>
